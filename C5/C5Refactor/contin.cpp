...
/*                     */
/*************************************************************************/
void C5Core::EvalContinuousAtt(Attribute Att, CaseNo Fp, CaseNo Lp)
{
  ...
  if ( BestGain <= 0 ) {
    ...
    Gain[Att] = (float)BestGain;
    Info[Att] = (float)BestInfo;
...
/*                                                                   */
/*************************************************************************/
void C5Core::EstimateMaxGR(Attribute Att, CaseNo Fp, CaseNo Lp)
{
  CaseNo  i, j;
...
/*                     */
/*************************************************************************/
void C5Core::PrepareForContin(Attribute Att, CaseNo Fp, CaseNo Lp)
{
  CaseNo  i;
  ClassNo  c;
  DiscrValue  v;
...
/*                     */
/*************************************************************************/
CaseNo C5Core::PrepareForScan(CaseNo Lp)
{
  CaseNo  i, j;
  ClassNo  c;
  double  w;
...
/*                                                                   */
/*************************************************************************/
void C5Core::ContinTest(Tree Node, Attribute Att)
{
  Sprout(Node, 3);
...
/*                                                                   */
/*************************************************************************/
void C5Core::AdjustAllThresholds(Tree T)
{
  Attribute  Att;
  CaseNo  Ep;
...
void C5Core::AdjustThresholds(Tree T, Attribute Att, CaseNo* Ep)
{
  DiscrValue  v;
  CaseNo  i;
...
/*                                                                   */
/*************************************************************************/
ContValue C5Core::GreatestValueBelow(ContValue Th, CaseNo* Ep)
{
  CaseNo  Low, Mid, High;
  Low  = 0;
  High = *Ep;
