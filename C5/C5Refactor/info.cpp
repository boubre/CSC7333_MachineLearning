...
/*                   */
/*************************************************************************/
double C5Core::ComputeGain(double BaseInfo, float UnknFrac, DiscrValue MaxVal, CaseCount TotalCases)
{
  DiscrValue  v;
  double  ThisInfo = 0.0;
...
/*                   */
/*************************************************************************/
double C5Core::TotalInfo(double V[], DiscrValue MinVal, DiscrValue MaxVal)
{
  DiscrValue  v;
...
/*                   */
/*************************************************************************/
void C5Core::PrintDistribution(Attribute Att, DiscrValue MinVal, DiscrValue MaxVal, double** Freq, double* ValFreq, Boolean ShowNames)
{
  DiscrValue v;
  ClassNo c;
  String Val;
