...
/*                   */
/*************************************************************************/
void C5Core::EvalDiscreteAtt(Attribute Att, CaseCount Cases)
{
...
/*                   */
/*************************************************************************/
void C5Core::EvalOrderedAtt(Attribute Att, CaseCount Cases)
{
  CaseCount  KnownCases;
...
/*                   */
/*************************************************************************/
void C5Core::SetDiscrFreq(Attribute Att)
{
  ClassNo  c;
  DiscrValue  v;
  int    x;
...
/*                    */
/*************************************************************************/
double C5Core::DiscrKnownBaseInfo(CaseCount KnownCases, DiscrValue MaxVal)
{
  ClassNo  c;
...
/*                   */
/*************************************************************************/
void C5Core::DiscreteTest(Tree Node, Attribute Att)
{
  int    S, Bytes;
  DiscrValue  v, CutV;
  if ( Ordered(Att) ) {
