...
/*                   */
/*************************************************************************/
void C5Core::InitialiseBellNumbers()
{
  DiscrValue   n, k;
...
/*                   */
/*************************************************************************/
void C5Core::EvalSubset(Attribute Att, CaseCount Cases)
{
  ...
  if ( Prelim ) {
    ...
    Penalty  = ( finite(Bell[InitialBlocks][GEnv.Blocks]) ? Log(Bell[InitialBlocks][GEnv.Blocks]) : (InitialBlocks - GEnv.Blocks + 1) * Log(GEnv.Blocks) );
  ...
  while ( GEnv.Blocks > 2 ) {
    ...
    Penalty  = ( finite(Bell[InitialBlocks][GEnv.Blocks - 1]) ? Log(Bell[InitialBlocks][GEnv.Blocks - 1]) : (InitialBlocks - GEnv.Blocks + 1) * Log(GEnv.Blocks - 1) );
...
/*                   */
/*************************************************************************/
void C5Core::Merge(DiscrValue x, DiscrValue y, CaseCount Cases)
{
  ClassNo  c;
  double  Entr = 0;
...
/*                   */
/*************************************************************************/
void C5Core::EvaluatePair(DiscrValue x, DiscrValue y, CaseCount Cases)
{
  ClassNo  c;
  double  Entr = 0;
...
/*                   */
/*************************************************************************/
Boolean C5Core::SameDistribution(DiscrValue V1, DiscrValue V2)
{
  ClassNo  c;
  CaseCount  D1, D2;
  D1 = GEnv.ValFreq[V1];
...
/*                   */
/*************************************************************************/
void C5Core::AddBlock(DiscrValue V1, DiscrValue V2)
{
  ClassNo  c;
  int    b;
...
/*                   */
/*************************************************************************/
void C5Core::MoveBlock(DiscrValue V1, DiscrValue V2)
{
  ClassNo  c;
  ForEach(c, 1, MaxClass) {
    GEnv.Freq[V1][c] = GEnv.Freq[V2][c];
...
/*                   */
/*************************************************************************/
void C5Core::PrintSubset(Attribute Att, Set Ss)
{
  DiscrValue  V1;
  Boolean  First = true;
  ForEach(V1, 1, MaxAttVal[Att]) {
...
/*                   */
/*************************************************************************/
void C5Core::SubsetTest(Tree Node, Attribute Att)
{
  int  S, Bytes;
  ...
  ForEach(S, 1, Node->Forks) {
    Node->Subset[S] = AllocateMem(Bytes, Byte);
